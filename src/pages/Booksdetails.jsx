            ...
            <div className='   flex w-full px-4 py-10 pt-4'>  {/* border-4 border-solid border-blue-500 */}
                ...
                <div className="w-1/2   px-4">{/* border-4 border-solid border-red-500  */}
                    ...
                    <div className="my-4 flex gap-">
                        <h1 className=''><span className="pr-6 font-extrabold ">Tag</span><span className="px-2 py-0.5 rounded-2xl font-semibold bg-[#22be0a3b] text-[#23BE0A] mr-3 ">#{blog.tags[0]}</span><span className="px-2 py-0.5 rounded-2xl font-semibold bg-[#00000012] text-[#23BE0A] ">#{blog.tags[1]}</span></h1>
                    </div>
